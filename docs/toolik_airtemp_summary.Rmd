...
toolik_weather <- read_csv(here::here("data", "data-raw", "toolik_weather.csv"),
                           na = "#N/A")
# data.table::fread()
# na = #N/A to correct manually inputed null values
```
...
# What is this %>% thing? Meet the pipe operator! Also, as of a couple months ago, |> is a native pipe operator (versus %>%, which comes along with the tidyverse) use -> ctrl + shift + m         %>% 
